...
edit_userfriend GET    /userfriends/:id/edit(.:format) userfriends#edit
   ...
   edit_comment GET    /comments/:id/edit(.:format)    comments#edit
       ...
       settings GET    /settings(.:format)             users#edit
         delete GET    /delete(.:format)               users#destroy
        newpost GET    /newpost(.:format)              posts#new
        delpost GET    /delpost(.:format)              posts#destroy
         edpost GET    /edpost(.:format)               posts#edit
   find_friends GET    /find_friends(.:format)         users#index
        friends GET    /friends(.:format)              userfriends#show